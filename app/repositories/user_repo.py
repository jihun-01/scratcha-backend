...
class UserRepository:
    ...
    def getUserByEmail(self, email: str, includeDeleted: bool = False) -> User:
    ...
    def updateUser(self, dbUser: User, userUpdate: UserUpdate) -> User:
        """
    ...
    def updateUserPlan(self, dbUser: User, new_plan: str) -> User:
        """
        사용자의 구독 플랜을 업데이트합니다.
        """
    ...
    def deleteUser(self, dbUser: User) -> User:
        """
        User 객체를 소프트 삭제합니다.
        """
    ...
    def getUserByIdAdmin(self, userId: str, includeDeleted: bool = False) -> User | None:
        """
